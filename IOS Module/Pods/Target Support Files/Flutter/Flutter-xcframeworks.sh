...
install_xcframework "${PODS_ROOT}/../../click-flutter/.ios/Flutter/engine/Flutter.xcframework" "Flutter" "framework" "ios-armv7_arm64/Flutter.framework" "ios-x86_64-simulator/Flutter.framework"
