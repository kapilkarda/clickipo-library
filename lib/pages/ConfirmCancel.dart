          ...
          child: Column(
            children: <Widget>[
              Container(
                ...
                child: Text("Are you sure?",style: TextStyle(fontSize:30,color: Colors.blueGrey,fontWeight: FontWeight.bold ),),
              ),
              Container(
                  margin: EdgeInsets.only(top: 24),
                  child: Text("Cancelling your order for ${String.fromCharCode(036)}12,000 of AAAJJ",style: TextStyle(fontSize:24, fontWeight: FontWeight.bold ),textAlign: TextAlign.center,)
              ),
              GestureDetector(
                onTap: (){
